...
> 📋 **Подробный отчёт по стеку** — в [`docs/tech_stack.md`](tech_stack.md): разделение на технологии по заданию и дополнительно подключенные, с обоснованием выбора каждой.
